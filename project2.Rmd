...
The likelihood (data) is a product of binomial pdf and the prior distributions for the parameters $\beta_0$ and $\betat_1$ are chosen to be two independent normal distributions $\sim(0, 15^2)$:
...
With the assumption of the independence of the two parameters $\beta_0$ and $\beta_0$, we can perform the sampling process in bivariate manner:
